...
<h1>Amigo Secreto</h1>
<p>Este projeto auxilia para realizar o sorteio de amigo secreto, permitindo a inserção dos participantes de depoois realizando o sorteio</p>
...
Aqui está o README atualizado com a inclusão da descrição do projeto de Amigo Secreto:
